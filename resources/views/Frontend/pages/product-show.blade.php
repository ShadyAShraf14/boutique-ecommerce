...
@section('content')
    ...
    <style>
        ...
        /* Wishlist button (لما يكون المنتج مفضل) */
        .wishlist-btn.is-fav {
    ...
    @php
        // نتأكد إن $mediaItems Collection
        $mediaItems = isset($mediaItems)
            ? ($mediaItems instanceof \Illuminate\Support\Collection
                ? $mediaItems
                : collect($mediaItems))
            : collect();

        // لو الكولكشن فاضي نحط thumbnail واحدة بالصورة الرئيسية
        if ($mediaItems->isEmpty() && !empty($mainImage)) {
            $mediaItems = collect([(object) ['original_url' => $mainImage]]);
        }

        // الـ wishlist من الـ session
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="d-flex align-items-baseline gap-3 mb-2">
                        ...
                        <div class="price-old">$ {{ number_format($product->price * 1.2, 2) }}</div>
                    </div>
                        ...
                        <form action="{{ route('frontend.cart.add', $product->id) }}" method="POST"
                            ...
                            <div>
                                ...
                                <div class="qty-wrapper">
                                    <button type="button" class="qty-btn" data-qty-change="-1">–</button>
                    ...
                    <div class="tab-content border border-top-0 p-4 small bg-white" id="productTabContent">
                        ...
                        <div class="tab-pane fade" id="reviews-pane" role="tabpanel">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <small class="text-muted">
                                            ...
                                            ({{ $reviewsCount }}
                                            {{ \Illuminate\Support\Str::plural('review', $reviewsCount) }})
                                        </small>
                                    </div>
                                </div>
                            ...
                            @auth
                                ...
                                <form method="POST" action="{{ route('frontend.products.reviews.store', $product) }}"
                                    class="small">
                                    @csrf
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <select name="rating"
                                            class="form-select form-select-sm @error('rating') is-invalid @enderror"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="comment" rows="3" class="form-control form-control-sm @error('comment') is-invalid @enderror"
                    ...
                    <div class="mt-5">
                        ...
                        <div class="row g-4">
                            @foreach ($relatedProducts as $related)
                                @php
                                    $relatedImg =
                                        $related->getFirstMediaUrl('images') ?:
    ...
    {{-- JS: تغيير الصورة الرئيسية + كنترول الكمية --}}
    <script>
